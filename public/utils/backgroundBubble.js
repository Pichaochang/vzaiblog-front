//获取用户传入的配置
let bubbleNumber = 0.1
let bubbleAlpha = 0.7
let alphaChangeSpeed = 0.0005
let size = 0.3
let sizeChangeSpeed = 0.001
let riseSpeed = 0.9
...
function bubble(
  aurora_bubbleNumber,
  aurora_bubbleAlpha,
  aurora_alphaChangeSpeed,
  aurora_size,
  aurora_sizeChangeSpeed,
  aurora_riseSpeed,
  aurora_color
) {
...
bubble(bubbleNumber,bubbleAlpha,alphaChangeSpeed,size,sizeChangeSpeed,riseSpeed,color)
